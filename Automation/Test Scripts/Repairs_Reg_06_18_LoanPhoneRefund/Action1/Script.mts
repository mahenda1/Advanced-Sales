...
TestScriptName = "Repairs_Reg_06_9_RepairHeaderVerification"
...
Function RetrieveVerification()
	...
	If (JavaWindow("Oracle Retail Xstore Point").JavaButton("Retrieve").Exist) Then
		Reporter.ReportEvent micPass, "Retreieve button is displayed","Test passed"
		Else
		Reporter.ReportEvent micFail, "Retrieve button is not displayed", "Test failed"
	End If 
...
Function RepairTable()
	Wait 1
	If (JavaWindow("Oracle Retail Xstore Point").JavaList("Repair Payment").Exist) Then
		Reporter.ReportEvent micPass, "The repair table is displayed","Test Passed"
		Else
		Reporter.ReportEvent micFail, "The repair table is not displayed","Test Passed"
	End If
...
Function RepairHeader()
	...
	If (JavaWindow("Oracle Retail Xstore Point").JavaObject("DtvList$ColumnHeader").Exist) Then
		Reporter.ReportEvent micPass, "The Repair Header is displayed","Test Passed"
		Else
		Reporter.ReportEvent micFail, "The Repair header is not displayed","Test failed"
